...
public class JavaMongoDB {
	...
	public static void main(String[] args) {
		try {
			...
			// Get MongoDb Database. If The Database Doesn't Exists, MongoDb Will
			// Automatically Create It For You
			DB dbObj = mongoClntObj.getDB("mongodbdcrud");

			// Get MongoDb Collection. If The Collection Doesn't Exists, MongoDb Will
			// Automatically Create It For You
			...
			for (int i = 0; i < array_names.length; i++) {
				...
				address = pickAddress();
				documentObj.append("address", new BasicDBObject("country", address[0]).append("state", address[1])
			...
			/**** UPDATE OPERATION ****/
			// Update Documents Found By The Query i.e. Update The Documents Having 'Age >
			// 40'
